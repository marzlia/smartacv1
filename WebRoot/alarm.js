...
Smart.Alarm = function (){
	...
	this.store = new Ext.data.Store({
		url : 'findAllAlarm.action?type=128',
		remoteSort : true,
	...
	this.cm = new Ext.grid.ColumnModel({
		...
		columns: [{header : '编号',	width : 30,	dataIndex : 'alarmId'},
			...
			{header : '异常码',	width : 90,	dataIndex : 'alarmCode'},
	...
	this.image.tpl =  new Ext.XTemplate(
		'<tpl for=".">',
		    '<div class="thumb-wrap" id="{imageId}" qtip=\'<img src="system/{imageUrl}" />\'>',
	...
	Smart.Alarm.superclass.constructor.call(this, {
		id: "smart-alarm",
		title : "警告追忆",
		border : false,
		margins: '0 0 5 0',
...
Ext.extend(Smart.Alarm, Ext.Panel, {
	initComponent: function(){
		Smart.Alarm.superclass.initComponent.call(this);
	}
});